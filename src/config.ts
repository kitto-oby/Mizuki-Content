...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://201552.xyz/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-01", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	themeColor: {
		hue: 201, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	bilibili: {
		vmid: "529500992", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/kitto-oby",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/529500992",
					external: true,
